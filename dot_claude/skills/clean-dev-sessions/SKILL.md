...
description: Clean up stale `dev <task>` tmux sessions, their git worktrees, and merged local/remote branches in the loancrate monorepo. Use when asked to "clean up dev sessions", "clean up stale sessions/worktrees", or after a batch of PRs merge.
---
